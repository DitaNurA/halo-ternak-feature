...
<div class="mt-4 grid grid-cols-1 gap-4 ">
    ...
    <div class="rounded-xl p-2 m-2 flex items-center border border-green-500">
        ...
        <div>
            ...
            <p class="text-sm text-blue-500">Layanan ini mencakup diagnosa, pengobatan, dan pemulihan untuk ternak yang
    ...
    <div class="condition-choice m-2">
        <div class="flex space-x-2 justify-center">
            <label class="inline-flex items-center border border-blue-500 text-blue-500 hover:bg-blue-50 bg-white rounded-lg px-6 py-1 flex-1">
                <input type="radio" class="form-radio text-white mr-4" name="condition" value="sakit">
                <span class="text-medium">Sakit</span>
            </label>
            <label class="inline-flex items-center border border-blue-500 text-blue-500 hover:bg-blue-50 bg-white rounded-lg px-6 py-1 flex-1">
                <input type="radio" class="form-radio text-white mr-4" name="condition" value="tidak_sakit">
                <span class="text-medium">Tidak Sakit</span>
            </label>
        </div>
    </div>
