<?= $this->section('list_riwayat'); ?>
<div class="mb-8 rounded-2xl border border-green-500">
    <h2 class="text-blue-600 text-xl font-medium ml-6 mt-6">Riwayat Pesanan</h2>
    <div class="h-1 mt-1 bg-green-500 ml-6 max-w-[60%]"></div>

    <div class="mt-4 grid grid-cols-1 gap-4">
        <!-- Contoh item -->
        <div class="flex items-center bg-white p-4 rounded-lg border border-green-500 ml-6 mr-6">
            ...
            <div class="ml-4">
                ...
                <div>
                    ...
                    <button class="bg-blue-500 text-white text-sm px-2 py-1 rounded mt-2" 
                    ><a href="<?= base_url('h_order1') ?>">Lihat Pesanan</a></button>
                </div>
            </div>
        </div>
        <div class="flex items-center shadow p-4 rounded-lg border border-green-500 ml-6 mr-6">
            ...
            <div class="ml-4">
                ...
                <div>
                    <span class="text-green-600 text-sm bg-green-100 px-2 py-1 rounded mt-1">di Latsari</span>
                    <button class="bg-blue-500 text-white text-sm px-2 py-1 rounded mt-2">
                        <a href="<?= base_url('h_order2')?>">Lihat Pesanan</a></button>
                </div>
            </div>
        </div>
        <div class="flex items-center shadow p-4 rounded-lg border border-green-500 ml-6 mr-6">
            ...
            <div class="ml-4">
                ...
                <div>
                    <span class="text-green-600 text-sm bg-green-100 px-2 py-1 rounded mt-1">di Latsari</span>
                    <button class="bg-blue-500 text-white text-sm px-2 py-1 rounded mt-2">
                    <a href="<?= base_url('h_order3')?>">Lihat Pesanan</a></button>
                </div>
            </div>
        </div>
