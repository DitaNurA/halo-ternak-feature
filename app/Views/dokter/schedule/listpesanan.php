<?= $this->section('listpesanan'); ?>
<div class="mb-8 rounded-2xl border border-green-500 ">
    <h2 class="text-blue-600 text-xl font-medium ml-6 mt-6">Pesanan Terdekat</h2>
        ...
        <div class="flex items-center bg-white p-4 rounded-lg border border-green-500 ml-6 mr-6">
            ...
            <div class="ml-4">
                ...
                <div>
                    ...
                    <button class="bg-blue-500 text-white text-sm px-2 py-1 rounded mt-2" href="<?= base_url('schedule') ?>">Lihat Pesanan</button>
                </div>
            </div>
        </div>
